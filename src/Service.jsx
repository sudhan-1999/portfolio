          ...
          <div className="card" style={{ width: "18rem",height:"19rem" }}>
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                Whether it's a dynamic website, an e-commerce platform, or a custom
                web solution, I ensure seamless functionality, optimized
        ...
        <div className="col">
          <div className="card" style={{ width: "18rem",height:"19rem" }}>
            <div className="card-body">
              ...
              <p className="card-text">
                I create visually stunning and user-friendly interfaces that enhance
                user experience. With a keen eye for design and expertise in HTML,
                CSS, JavaScript, and Figma, I craft responsive and interactive UI
                components that align with modern trends and best practices.
              </p>
            </div>
          </div>
        </div>
